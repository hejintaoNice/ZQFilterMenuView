...
@property (nonatomic, copy) void (^selectBlock)(ZQTabMenuMoreView *view,NSMutableDictionary *selectDic,NSMutableDictionary *moreSeletedDic,NSInteger minPrice,NSInteger maxPrice);
//选择颜色
