...
- (UIView *)minLineView {
    if (!_minLineView) {
        ...
        _minLineView.backgroundColor = [[UIColor alloc] initWithRed:244/255.0 green:246/255.0 blue:252/255.0 alpha:1];
...
- (UIView *)midLineView {
    if (!_midLineView) {
        ...
        _midLineView.backgroundColor = [[UIColor alloc] initWithRed:61/255.0 green:124/255.0 blue:245/255.0 alpha:1];
...
- (UIView *)maxLineView {
    if (!_maxLineView) {
        ...
        _maxLineView.backgroundColor = [[UIColor alloc] initWithRed:244/255.0 green:246/255.0 blue:252/255.0 alpha:1];
